...
\subsection{{\tt line}, {\tt spline}, {\tt arrow}, {\tt move}}
  ...
  {\tt last line.wid} returns the arrowhead width of the line;
  similarly for {\tt .ht} and for the other linear objects including {\tt move}.
  The arrowhead height value is returned by {\tt last line.ht}.
...
\subsection{PSTricks anomaly}
  At some time in the mid 2000 to 2010 interval,
